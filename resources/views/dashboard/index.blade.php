...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-yellow-500">
        ...
        <a href="{{ route('pedidos.index', ['status' => 'Pendente']) }}"
            class="text-sm text-yellow-600 dark:text-yellow-400 hover:underline mt-4 inline-block">
            Ver todos →
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-blue-500">
        ...
        <a href="{{ route('pedidos.index', ['status' => 'Enviado']) }}"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-green-500">
        ...
        <a href="{{ route('pedidos.index', ['status' => 'Aprovado']) }}"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-red-500">
        ...
        <a href="{{ route('pedidos.index', ['status' => 'Devolvido']) }}"
            class="text-sm text-red-600 dark:text-red-400 hover:underline mt-4 inline-block">
            Ver todos →
        </a>
    </div>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="{{ route('pedidos.index') }}"
            class="flex items-center p-4 bg-green-50 dark:bg-green-900 rounded-lg hover:bg-green-100 dark:hover:bg-green-800 transition">
        ...
        <a href="{{ route('conferencia.index') }}"
            class="flex items-center p-4 bg-blue-50 dark:bg-blue-900 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-800 transition">
        ...
        <a href="{{ route('usuarios.index') }}"
            class="flex items-center p-4 bg-purple-50 dark:bg-purple-900 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-800 transition">
