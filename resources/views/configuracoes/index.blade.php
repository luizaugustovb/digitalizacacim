<x-layout page-title="Configurações">
    <div class="max-w-6xl mx-auto space-y-6" x-data="{ tab: 'geral' }">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
            ...
            <!-- Formulário -->
            <form method="POST" action="{{ route('configuracoes.update') }}" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div x-show="tab === 'geral'" class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nome_sistema" value="{{ old('nome_sistema', $config['geral']['nome_sistema']) }}"
                    ...
                    <div>
                        ...
                        <input type="email" name="email_notificacoes" value="{{ old('email_notificacoes', $config['geral']['email_notificacoes']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <select name="timezone"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                            <option value="America/Sao_Paulo" {{ $config['geral']['timezone'] === 'America/Sao_Paulo' ? 'selected' : '' }}>Brasília (GMT-3)</option>
                            <option value="America/Manaus" {{ $config['geral']['timezone'] === 'America/Manaus' ? 'selected' : '' }}>Manaus (GMT-4)</option>
                            <option value="America/Rio_Branco" {{ $config['geral']['timezone'] === 'America/Rio_Branco' ? 'selected' : '' }}>Rio Branco (GMT-5)</option>
                        </select>
                    </div>
                </div>
                ...
                <div x-show="tab === 'documentos'" class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="dias_retencao_documentos" min="365" max="3650"
                            value="{{ old('dias_retencao_documentos', $config['documentos']['dias_retencao_documentos']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="tamanho_maximo_arquivo" min="1" max="50"
                            value="{{ old('tamanho_maximo_arquivo', $config['documentos']['tamanho_maximo_arquivo']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="formatos_permitidos"
                            value="{{ old('formatos_permitidos', $config['documentos']['formatos_permitidos']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="qualidade_compressao" min="50" max="100"
                            value="{{ old('qualidade_compressao', $config['documentos']['qualidade_compressao']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <a href="{{ route('configuracoes.pendencias.index') }}"
                ...
                <div x-show="tab === 'produtividade'" class="space-y-6">
                    <div>
                        ...
                        <input type="number" name="meta_diaria_atendente" min="1"
                            value="{{ old('meta_diaria_atendente', $config['produtividade']['meta_diaria_atendente']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="meta_diaria_gestor" min="1"
                            value="{{ old('meta_diaria_gestor', $config['produtividade']['meta_diaria_gestor']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="alerta_pedidos_antigos_dias" min="1" max="30"
                            value="{{ old('alerta_pedidos_antigos_dias', $config['produtividade']['alerta_pedidos_antigos_dias']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                ...
                <div x-show="tab === 'importacao'" class="space-y-6">
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="importacao_automatica" value="1"
                                {{ old('importacao_automatica', $config['importacao']['importacao_automatica']) === 'true' ? 'checked' : '' }}
                    ...
                    <div>
                        ...
                        <input type="time" name="horario_importacao"
                            value="{{ old('horario_importacao', $config['importacao']['horario_importacao']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="number" name="importacao_timeout" min="10" max="300"
                            value="{{ old('importacao_timeout', $config['importacao']['importacao_timeout']) }}"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Convênios Permitidos (códigos)
                        </label>
                        <textarea name="importacao_convenios_permitidos" rows="3"
                            placeholder="Ex: UNIMED, BRADESCO, AMIL"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">{{ old('importacao_convenios_permitidos', $config['importacao']['importacao_convenios_permitidos']) }}</textarea>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Deixe em branco para importar todos. Separe por vírgula.</p>
                    </div>
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="sqlserver_host"
                                    value="{{ old('sqlserver_host', $config['importacao']['sqlserver_host']) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="sqlserver_database"
                                    value="{{ old('sqlserver_database', $config['importacao']['sqlserver_database']) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="sqlserver_username"
                                    value="{{ old('sqlserver_username', $config['importacao']['sqlserver_username']) }}"
                                    placeholder="usuario"
                                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                ...
                <div x-show="tab === 'integracao'" class="space-y-6">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" name="softlab_host" value="{{ env('SOFTLAB_DB_HOST', '127.0.0.1') }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <input type="text" name="softlab_port" value="{{ env('SOFTLAB_DB_PORT', '3306') }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                placeholder="3306">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="softlab_database" value="{{ env('SOFTLAB_DB_DATABASE', 'BD_SOFTLAB_P00') }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                        ...
                        <div>
                            ...
                            <input type="text" name="softlab_username" value="{{ env('SOFTLAB_DB_USERNAME', 'root') }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                placeholder="root">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="password" name="softlab_password" value="{{ env('SOFTLAB_DB_PASSWORD', '') }}"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                                placeholder="••••••••">
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                        <a href="{{ route('configuracoes.softlab.mappings') }}"
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="notificar_pedido_devolvido" value="1"
                                {{ old('notificar_pedido_devolvido', $config['notificacoes']['notificar_pedido_devolvido']) === 'true' ? 'checked' : '' }}
                                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="notificar_pedido_aprovado" value="1"
                                {{ old('notificar_pedido_aprovado', $config['notificacoes']['notificar_pedido_aprovado']) === 'true' ? 'checked' : '' }}
                                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                    ...
                    <div>
                        <label class="flex items-center">
                            <input type="checkbox" name="notificar_meta_atingida" value="1"
                                {{ old('notificar_meta_atingida', $config['notificacoes']['notificar_meta_atingida']) === 'true' ? 'checked' : '' }}
                                class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
